...
- GitHub Actions `iOS App Build` run `26403603481` passed after push, including shared JVM tests, Xcode project generation, unsigned device build, IPA packaging, and artifact upload.
