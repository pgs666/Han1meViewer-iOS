...
class SharedAppEnvironment(
    ...
    private val videoLanguageProvider: () -> String = { preferencesStore.videoLanguage.get() }
    ...
    private val commentRepository = KtorCommentRepository(sessionStore, baseUrl = baseUrl, client = httpClient, videoLanguageProvider = videoLanguageProvider)
    private val userVideoListRepository = KtorUserVideoListRepository(sessionStore, baseUrl = baseUrl, client = httpClient, videoLanguageProvider = videoLanguageProvider)
    private val userPlaylistRepository = KtorUserPlaylistRepository(sessionStore, baseUrl = baseUrl, client = httpClient, videoLanguageProvider = videoLanguageProvider)
    private val onlineWatchHistoryRepository = KtorOnlineWatchHistoryRepository(sessionStore, baseUrl = baseUrl, client = httpClient, videoLanguageProvider = videoLanguageProvider)
